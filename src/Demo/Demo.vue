  ...
  data() {
    return {
      ...
      content: [
        ...
        '<div class="template" contenteditable="true"><div class="grid-2-cols"><h1>Hello world!</h1><p>This is a rich-text editor built on top of <a href="https://vuejs.org/" target="_blank">Vue.js</a> using the native <i>contenteditable</i> browser implementation and some JavaScript trickery to spread content over paper-sized pages.</p><p>This is a rich-text editor built on top of <a href="https://vuejs.org/" target="_blank">Vue.js</a> using the native <i>contenteditable</i> browser implementation and some JavaScript trickery to spread content over paper-sized pages.</p><p>This is a rich-text editor built on top of <a href="https://vuejs.org/" target="_blank">Vue.js</a> using the native <i>contenteditable</i> browser implementation and some JavaScript trickery to spread content over paper-sized pages.</p></div></div>',
